...
function Header({isLoggedIn, closeSession}){
    ...
    return(
        <header className="header">
          <div className="header__title">
              ...
              {isLoggedIn ? 
              (<><p className="heder__session">Aqui va tu correo</p><Link className="heder__session" to="/web_project_around_react/signin" onClick={closeSession}>Cerrar sesión </Link></>) 
              : 
              !isSignin ? 
